...
This script loads MARLEY ES data and creates detailed angular distribution plots
for the final-state electrons, including both polar (theta) and azimuthal (phi) angles.
"""
...
def load_electron_angles(root_file):
    ...
    with uproot.open(root_path) as f:
        ...
        # Load electron momentum components (r = right-hand final state = electron for ES)
